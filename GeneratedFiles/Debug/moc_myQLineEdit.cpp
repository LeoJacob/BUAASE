...
QT_MOC_LITERAL(1, 12, 7), // "getTips"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 5), // "rowId"
QT_MOC_LITERAL(4, 27, 5) // "colId"

    },
    "myQLineEdit\0getTips\0\0rowId\0colId"
};
...
void myQLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->getTips((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (myQLineEdit::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&myQLineEdit::getTips)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject myQLineEdit::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_myQLineEdit.data,
      qt_meta_data_myQLineEdit,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void myQLineEdit::getTips(int _t1, int _t2)
{
